              ...
              <DivInner>
                <div>
                  ...
                  <Field
                    ...
                    error={errors.aadhaarNumber ? errors.aadhaarNumber : ''}
                  ...
                  <Field
                    ...
                    autoComplete="off"
                    className="my-2 m-auto"
                    error={errors.securityCode ? errors.securityCode : ''}
                ...
                <BottomButtonDiv>
                  <Button className="m-auto" disabled={Object.keys(errors).length > 0} type="submit">
                    {t('send_otp')}
                  </Button>
                </BottomButtonDiv>
              </DivInner>
